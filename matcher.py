...
def calculate_skill_match(resume, job):
    ...
    def resolve_skill_groups(resume_skills, job_skills):
        """
        Remove missing skills that belong to a group already satisfied
        by another resume skill.
        """
        ...
        for skill in job_skills:
            ...
            group = SKILL_DATABASE[skill]["group"]

            if group is None:
                resolved_missing.append(skill)
                continue
            ...
            for resume_skill in resume_skills:
                ...
                if SKILL_DATABASE[resume_skill]["group"] == group:
                    satisfied = True
                    break
        ...
        return sorted(resolved_missing)
    ...
    missing_skills = resolve_skill_groups(
        resume_skills,
        job_skills,
    )
